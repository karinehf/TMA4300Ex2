...
```
The plot above shows the ratio between the observed number of cases of oral cancer and the expected number based on demographics, that is $y_i/E_i$ for all districts in Germany. The general tendency is slightly higher rates than expected in the north east and south west and lower than expect in the mid east.
