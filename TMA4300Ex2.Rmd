...
cat('  u comp', comp[1], ': test stat', gew.u1$z, ' p-value', p_u[comp[1]], '\n')
cat('  u comp', comp[2], ': test stat', gew.u2$z,' p-value', p_u[comp[2]], '\n')
cat('  u comp', comp[3], ': test stat', gew.u3$z,' p-value', p_u[comp[3]], '\n')

cat('eta comp', comp[1], ': test stat', gew.eta1$z,' p-value', p_eta[comp[1]],'\n')
cat('eta comp', comp[2], ': test stat', gew.eta2$z,' p-value', p_eta[comp[2]],'\n')
cat('eta comp', comp[3], ': test stat', gew.eta3$z,' p-value', p_eta[comp[3]],'\n')
